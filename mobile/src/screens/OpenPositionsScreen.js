...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 26, lineHeight: 31, letterSpacing: -0.6, marginTop: space(4) },
  bigNum: { fontFamily: "PlusJakartaSans_800ExtraBold", fontSize: 40, letterSpacing: -1, fontVariant: ["tabular-nums"] },
