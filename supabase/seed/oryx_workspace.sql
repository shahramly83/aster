-- ============================================================================
-- Aster: Oryx Digital Sdn Bhd workspace seed
-- ============================================================================
-- Seeds a clean, consistent sample workspace (jobs, candidates, applications,
-- interviews, scorecards) for the "Oryx Digital Sdn Bhd" company ONLY. It first
...
if not found_co then
  raise notice 'No company named "Oryx Digital Sdn Bhd" was found, nothing seeded. Run:  select id, name from public.companies;  to see exact names, then adjust the WHERE clause in this file.';
end if;
end $$;
