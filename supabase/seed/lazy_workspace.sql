-- ============================================================================
-- Aster: Lazy Sdn Bhd workspace seed
-- ============================================================================
...
if not found_co then
  raise notice 'No company named "Lazy Sdn Bhd" was found, nothing seeded. Run:  select id, name from public.companies;  to see exact names, then adjust the WHERE clause in this file.';
end if;
end $$;
