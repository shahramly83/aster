...
loop
  ...
  (co.id,a3,j1,'applied',88,to_jsonb('Excellent React and TypeScript depth; creative UI background fits the design-system focus.'::text),'Career Page'),
  ...
  (co.id,a1,j3,'applied',79,to_jsonb('Design-system and Figma experience transfer well to product design.'::text),'Career Page'),
  ...
  (co.id,a2,j2,'applied',85,to_jsonb('Hands-on WordPress, PHP and WooCommerce match the role well.'::text),'JobStreet'),
