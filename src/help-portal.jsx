    ...
    <div className="help min-h-screen" style={{ background: "var(--bg)", color: "var(--ink)" }}>
      ...
      <header className="border-b" style={{ borderColor: "var(--line)" }}>
        <div className="max-w-5xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
          ...
          <a href="https://hireaster.com" aria-label="Aster home" title="Aster home" className="inline-flex items-center justify-center rounded-lg border w-9 h-9 transition-colors hover:bg-black/[0.03]" style={{ borderColor: "var(--brand)", color: "var(--brand)" }}>
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M3 9.5 12 3l9 6.5V20a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1V9.5Z" /></svg>
          </a>
        </div>
      </header>
